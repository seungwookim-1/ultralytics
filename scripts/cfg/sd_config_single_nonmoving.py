...
VIRTUAL_ROOT = Path("/ultralytics/run/sd_moe_nonmoving")
...
DATASET_YAML = VIRTUAL_ROOT / "multihead_data_single_nonmoving.yaml"
...
def sd_symlink_config_loader_n() -> SymlinkConfig:
